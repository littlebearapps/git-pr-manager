  ...
  describe("worktreeListCommand", () => {
    describe("successful cases", () => {
      it("should list all worktrees in plain text format", async () => {
        ...
        expect(logger.log).toHaveBeenCalledWith(
          expect.stringContaining("/Users/test/project/main"),
        );
        expect(logger.log).toHaveBeenCalledWith(
      ...
      it("should mark current worktree with asterisk", async () => {
        ...
        jest
          .spyOn(process, "cwd")
          .mockReturnValue("/Users/test/project/feature");
    ...
    describe("error cases", () => {
      it("should handle errors and output JSON error when --json flag is set", async () => {
        ...
        await expect(worktreeListCommand({ json: true })).rejects.toThrow(
          "process.exit called",
        );

        expect(logger.outputJsonResult).toHaveBeenCalledWith(false, undefined, {
          code: "GIT_ERROR",
      ...
      it("should handle errors and output plain text error when no --json flag", async () => {
        ...
        await expect(worktreeListCommand({})).rejects.toThrow(
          "process.exit called",
        );
  ...
  describe("worktreePruneCommand", () => {
    ...
    describe("error cases", () => {
      it("should handle prune errors and fail spinner", async () => {
        ...
        await expect(worktreePruneCommand({})).rejects.toThrow(
          "process.exit called",
        );
      ...
      it("should output JSON error when --json flag is set", async () => {
        ...
        await expect(worktreePruneCommand({ json: true })).rejects.toThrow(
          "process.exit called",
        );
