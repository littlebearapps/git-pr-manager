...
import { GitHubService, AuthError, PRExistsError, NotFoundError, MergeBlockedError, MergeConflictError } from '../../src/services/GitHubService';
...
describe('GitHubService', () => {
  ...
  describe('Constructor', () => {
    ...
    it('should parse owner and repo from git remote if not provided', () => {
      childProcess.execSync.mockReturnValue('git@github.com:littlebearapps/notebridge.git\n');
  ...
  describe('Authentication', () => {
    ...
    it('should throw AuthError on authentication failure', async () => {
      ...
      await expect(service.verifyAuth()).rejects.toThrow('GitHub authentication failed');
    });
  });
  ...
  describe('PR Operations', () => {
    ...
    describe('getPR', () => {
      ...
      it('should throw NotFoundError when PR not found', async () => {
        ...
        await expect(service.getPR(999)).rejects.toThrow('Pull request #999 not found');
      });
    });
    ...
    describe('mergePR', () => {
      ...
      it('should throw MergeBlockedError on 405 status', async () => {
        ...
        await expect(service.mergePR(123, { method: 'merge' }))
          .rejects.toThrow(MergeBlockedError);
        await expect(service.mergePR(123, { method: 'merge' }))
          .rejects.toThrow('PR cannot be merged (conflicts or failed checks)');
      });
      ...
      it('should throw MergeConflictError on 409 status', async () => {
        ...
        await expect(service.mergePR(123, { method: 'merge' }))
          .rejects.toThrow('PR has merge conflicts');
      });
    });
  });
  ...
  describe('Branch Operations', () => {
    ...
    it('should throw error when branch does not exist', async () => {
      ...
      await expect(service.deleteBranch('nonexistent'))
        .rejects.toThrow('Branch nonexistent does not exist or already deleted');
    });
  });
  ...
  describe('URL Parsing', () => {
    beforeEach(() => {
      ...
      childProcess.execSync.mockReturnValue('git@github.com:testowner/testrepo.git\n');
    ...
    it('should parse HTTPS git URL', () => {
      childProcess.execSync.mockReturnValue('https://github.com/littlebearapps/notebridge.git\n');
    ...
    it('should throw error for non-GitHub URL', () => {
      childProcess.execSync.mockReturnValue('https://gitlab.com/owner/repo.git\n');
