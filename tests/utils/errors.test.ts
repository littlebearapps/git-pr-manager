...
describe('Error Classes', () => {
  describe('WorkflowError (Base Class)', () => {
    ...
    it('should create error with all parameters', () => {
      ...
      const error = new WorkflowError('TEST_CODE', 'Test message', details, suggestions);
  ...
  describe('RateLimitError', () => {
    ...
    it('should use custom suggestions if provided', () => {
      ...
      const error = new RateLimitError('Rate limit hit', undefined, customSuggestions);
  ...
  describe('BranchProtectionError', () => {
    ...
    it('should use custom suggestions if provided', () => {
      ...
      const error = new BranchProtectionError('Protected', {}, customSuggestions);
  ...
  describe('SecurityError', () => {
    ...
    it('should use custom suggestions if provided', () => {
      ...
      const error = new SecurityError('Secrets found', undefined, customSuggestions);
